...
main() {
    ...
    if [[ $theme == gloom ]]; then
        ...
        source "$TMUX_LABYRINTH_DIR/dist/labyrinth-gloom.tmux"
        ...
        # thm_highlight_med="#242b20"
        # thm_highlight_high="#292f24"
        source "$TMUX_LABYRINTH_DIR/dist/labyrinth-dusk.tmux"
        ...
        source "$TMUX_LABYRINTH_DIR/dist/labyrinth-mist.tmux"
    fi
